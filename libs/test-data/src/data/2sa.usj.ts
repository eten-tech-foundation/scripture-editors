...
export const usj2Sa: Usj = {
  ...
  content: [
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          marker: "bd",
          closed: "false",
          content: ["Footnotes and crossrefs:"],
        },
      ],
    },
    {
      ...
      marker: "p",
      content: [
        "The footnote in this paragraph has a category without markers in its content, so it should be an attribute on the footnote",
        {
          type: "note",
          marker: "f",
          caller: "+",
    ...
    },
    {
      ...
      marker: "p",
      content: [
        "The end footnote in this paragraph has a category without markers in its content but with a space after, so it should be an attribute on the footnote ",
        {
          type: "note",
          marker: "fe",
          caller: "+",
            ...
            "inside notes",
            {
              ...
              content: [
                ...
                },
                {
                  ...
                  marker: "ft",
                  closed: "false",
                  content: ["Footnote text with a "],
                },
                {
                  type: "char",
                  marker: "wj",
                  content: ["character marker"],
                },
              ],
            },
    ...
    },
    {
      type: "para",
      marker: "p",
      content: ["This line has no milestone."],
    },
    {
      type: "para",
      marker: "p",
    ...
    },
    {
      type: "para",
      marker: "p",
      content: ["For some reason, Paratext does not recognize the ts "],
    },
    {
      type: "para",
      marker: "ts",
    ...
    },
    {
      type: "para",
      marker: "p",
      content: ["See the id marker at the top of this book for its code leading attribute"],
    },
    {
      type: "para",
      marker: "p",
    ...
    },
    {
      type: "para",
      marker: "p",
      content: ["See the many verse markers in this chapter for their number leading attribute."],
    },
    {
      type: "para",
      marker: "p",
    ...
    },
    {
      type: "para",
      marker: "p",
      content: ["Tilde should be a NBSP in USX and USJ"],
    },
    {
      type: "para",
      marker: "p",
    ...
    },
    {
      type: "para",
      marker: "p",
      content: ["TODO: add some whitespace character tests"],
    },
    {
      type: "para",
      marker: "b",
    ...
    },
    {
      type: "para",
      marker: "li2",
      content: ["–Subpoint on the first list item"],
    },
    {
      type: "para",
      marker: "li3",
    ...
    },
    {
      type: "para",
      marker: "lf",
      content: ["Footer for the normal list."],
    },
    {
      type: "para",
      marker: "p",
      content: ["Following is an embedded list with just entries."],
    },
    {
      type: "para",
      marker: "lim1",
      content: ["First embedded list item"],
    },
    {
      type: "para",
      marker: "lim1",
      content: ["Second embedded list item"],
    },
    {
      type: "para",
      marker: "lim1",
      content: ["Third embedded list item"],
    },
    {
      type: "para",
      marker: "lim2",
      content: ["Subpoint on the third embedded list item"],
    },
    {
      type: "para",
      marker: "lim3",
      content: ["Subpoint on the subpoint on the third embedded list item"],
    },
    {
      type: "para",
      marker: "b",
      ...
      content: [
        {
          ...
          content: [
            ...
            },
            {
              ...
              align: "center",
              colspan: "2",
              content: ["Header 3-4 centered"],
            },
            {
              type: "table:cell",
              marker: "thr5",
              align: "end",
              content: ["Header 5 right"],
            },
          ],
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              marker: "tc2",
              align: "start",
              content: ["Row 1 cell 2 space after "],
            },
            {
              type: "table:cell",
              marker: "thc3",
              align: "center",
              content: ["Row 1 cell 3 centered"],
            },
            {
              type: "table:cell",
              marker: "thr4",
          ...
          content: [
            {
              ...
              align: "end",
              colspan: "4",
              content: ["Row 2 cell 1-4 right"],
            },
            {
              type: "table:cell",
              marker: "tc5",
              align: "start",
              content: ["Row 2 cell 5"],
            },
          ],
        },
      ],
      ...
      content: [
        {
          type: "para",
          marker: "p",
          content: ["This paragraph is in the sidebar."],
        },
        {
          type: "para",
          marker: "b",
